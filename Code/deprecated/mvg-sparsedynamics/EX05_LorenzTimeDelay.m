...
%figpath = '../figures/';
%addpath('./utils');
figpath = '/Users/mvg/bDrive/Projects/IDM/Figures/';
addpath('/Users/mvg/bDrive/Projects/IDM/scripts_idm/sparsedynamics/utils/');
...
% Plot identified system in (u,v,w) space.
tspan = [0 10.];
x0 = x(50,:);
